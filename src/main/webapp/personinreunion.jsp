...
<body>
    ...
    <div class="maincontainer">
        <table id="table_personne">
            ...
            <%
	            List<Personne> personnes = (List<Personne>)request.getAttribute("persones");
	            int idre =(int) request.getAttribute("idre");
            ...
            <tr>
                ...
                <td><%=p.getAge() %></td>
                <td><%=p.getEmail() %></td>
                <td><button class='delete-button' ><a href='?idpersonreunion=<%=p.getIdPersonne() %>&idreunion=<%= idre%>' class='button-link'>Remove</a></button></td>
